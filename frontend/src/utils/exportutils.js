...
export const exportMyApplicationToExcel = (application, user) => {
  const excelData = [
    ...
    {
      Field: "Preferred Subdepartment",
      Value: application.preferredSubdepartment || "N/A",
    },
    {
      Field: "Start Date",
    ...
    {
      Field: "End Date",
      Value: new Date(application.endDate).toLocaleDateString(),
    },
    {
      Field: "Status",
    ...
    {
      Field: "HR Comments",
      Value: application.hrComments || "No comments yet",
    },
    {
      Field: "HOD Comments",
      Value: application.hodComments || "No comments yet",
    },
  ];
...
export const exportMyApplicationToPDF = (application, user) => {
  ...
  doc.setFont(undefined, "normal");
  doc.text(
    `Preferred Department: ${application.preferredDepartment}`,
    14,
    yPos
  );
  yPos += 7;
  doc.text(
    `Subdepartment: ${application.preferredSubdepartment || "N/A"}`,
    14,
    yPos
  );
  yPos += 7;
