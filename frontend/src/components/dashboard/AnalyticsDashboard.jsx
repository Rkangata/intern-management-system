...
const AnalyticsDashboard = () => {
  ...
  const statusData = [
    ...
    {
      name: "HR Review",
      value: analytics.statusCounts.hr_review,
      color: "#3b82f6",
    },
    {
      name: "HOD Review",
      value: analytics.statusCounts.hod_review,
      color: "#8b5cf6",
    },
    {
      name: "Approved",
  ...
  const roleData = [
    ...
    {
      name: "Attachees",
      value: analytics.roleCounts.attachee,
      color: "#10b981",
    },
  ];
        ...
        <div className="container mx-auto px-4 py-6 flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-600 mt-1">
              Comprehensive overview of applications and trends
            </p>
          </div>
          {/* ✅ Export Button */}
          <button
              ...
              <div>
                ...
                <p className="text-4xl font-bold mt-2">
                  {analytics.statusCounts.pending +
                    ...
                    analytics.statusCounts.hod_review}
                </p>
              </div>
